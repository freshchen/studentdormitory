...
<html>
  <head>
    ...
    function showAbout(){
    	$.messager.show({
			title:"学生宿舍管理",
			msg:"设计: 凌晨<br/>邮箱: 961011595@qq.com",
			timeout:5000
		});
    }
 ...
 <body class="easyui-layout">  
    ...
    <div region="south" border="true" split="false"  
        ...
        <div class="footer">  
           © 版权所有：<a href="http://www.nuist.edu.cn/" target="_blank">南京信息工程大学滨江学院</a>&nbsp; 凌晨  &nbsp; QQ:961011595 
        </div>  
    </div>  
        ...
        <div id="tabs" class="easyui-tabs"  fit="true" >  
            <div title="欢迎使用" style="padding: 5px;" > <!--  style="background-image: url(image/welcome.gif)" -->
            	<div style="border:2px #95B8E7 solid;height:525px">
            		<center style="font-size:30px;">欢迎使用学生宿舍管理系统<br></center>
